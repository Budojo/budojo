...
/**
 * The desktop schedule (#1226, M11 #1218): same commands as WebSchedule,
 * different cadence — because a desktop app has no cron and is closed most
 * of the day.
 *
 ...
 * catches one). Wall-clock anchors survive only as the *earliest* time, via
 * between(), so nobody gets a toast at 00:01 for working late.
 *
 ...
 *
 * timezone() comes BEFORE between() on every reminder: between() resolves its

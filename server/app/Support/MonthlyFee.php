 ...
 *
 * **Its SQL twin is the "charged a fee" clause of `Athlete::scopeOwing`**
 * (#1722): tier or flat fee, non-null. Whatever branch lands here lands there
 * too, or the roster shows a dash on a row that `?paid=no`, the digest and the
 * overdue push still chase.
 */

 ...
 * @property bool         $leaderboard_visible  Opt-out flag for the monthly mat-hours leaderboard (#962). Default `true`. Flipping to `false` anonymises the user's row on the leaderboard card ("Anonimo") but sessions still count toward rank computation so the order stays faithful.

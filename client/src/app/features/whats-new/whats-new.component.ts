      ...
      sections: [
        {
          ...
          bullets: [
            "Press Ctrl+K (Windows / Linux) or ⌘K (Mac) anywhere in the dashboard and a search bar pops in the middle of the screen. Type three characters of an athlete's name and you get up to 8 matches in real time, ranked by relevance. Hit Enter or click a row to land on that athlete's detail page; press Escape to dismiss without leaving the page you were on. Way faster than scrolling the roster when you're trying to look someone up between classes.",
            'Belt + status alongside the name so two athletes with similar names are easy to disambiguate at a glance. Recent matches surface first.',
          ],
        },
        {

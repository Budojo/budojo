  ...
  protected readonly releases: readonly Release[] = [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            'Right above the feed, owners now see a "Post event" button. Tap it and a dialog opens with five fields: Title (required, 120 chars), When (calendar with time picker), Where (optional, 200 chars), Details (optional, up to 2000 chars), Max attendees (optional — leave empty for no cap).',

...
describe('CookiePolicyComponent — canonical English /cookie-policy (#421)', () => {
  ...
  it('renders manage-preferences as a real <button>, not a javascript: anchor', () => {
    ...
    // assistive-tech semantics + strict-CSP environments. The component-
    // level managePreferences() spy above passes either way; this DOM
    // assertion is the regression trip-wire.
    const { fixture } = setup();
    const root: HTMLElement = fixture.nativeElement;

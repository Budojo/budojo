...
import { Athlete, AthleteService, AthleteStatus, Belt } from '../../core/services/athlete.service';
...
/**
 * Stats dashboard (`/dashboard/stats`). First slice surfaces two
 * client-side aggregations from the athletes list — belt distribution

...
- `PATCH /api/v1/academy` — partial update of `name`, `address`, `monthly_fee_cents`, `carnet_price_cents`, `carnet_entries`, `carnet_entry_unit`, `training_days`, `season_start_month`, `billing_from`

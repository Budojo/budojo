...
| `GET` | `/api/v1/lessons/last-notes?syllabus_topic_id=` | The latest **held** lesson that named the topic and carried notes, or `null` (#1862). A living topic of the caller's academy, else 422. `attendance_read` |

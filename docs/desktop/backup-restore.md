...
Recovery only renames onto free names and only deletes a staged `.restoring` copy, never the owner's data. What it did is written to the main-process log.
